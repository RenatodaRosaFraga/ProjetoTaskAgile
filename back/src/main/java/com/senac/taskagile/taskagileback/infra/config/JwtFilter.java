...
public class JwtFilter extends OncePerRequestFilter {
    ...
    protected void doFilterInternal(HttpServletRequest request,
        ...
        if(path.equals("/auth/login")
                ...
                || (path.equals("/projetos") && request.getMethod().equals("GET"))
                || (path.equals("/projetos") && request.getMethod().equals("POST"))
                || (path.startsWith("/projetos/") && request.getMethod().equals("GET"))
                || (path.startsWith("/projetos/") && request.getMethod().equals("PUT"))
